...
[SIDEY Releases](https://github.com/sidey-app/SIDEY/releases)에서 `SIDEY-Windows-x64-v1.3.0-Setup.exe`를 받아 실행합니다.
...
### Windows · 2026년 9월 14일 · v1.3.0

- 아기 수달·아기 돼지·나무와 투척물 11종을 미리 보고 보유 상품을 사용할 수 있습니다.
- 캐릭터와 별도로 판매되는 애착 물건의 미리보기와 보유 상태를 함께 확인할 수 있습니다.
- 밝게·어둡게·Windows 기본값 테마를 선택할 수 있습니다.
- 상점의 긴 상품명·미리보기·스크롤과 로딩 표시를 개선했습니다.
- 트레이에서 업데이트를 확인하면 설정창을 열지 않고 Windows 알림으로 결과를 받습니다.
- 설치 오류 안내와 내부 안정성을 개선하고 진단 데이터 내보내기를 추가했습니다.

[Windows v1.3.0 변경 사항과 조작 안내](docs/releases/windows-v1.3.0.md)
